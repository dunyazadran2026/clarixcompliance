...
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/health-tech-hub-copenhagen.png" alt="Health Tech Hub Copenhagen" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/kitchen-aarhus.png" alt="Kitchen Aarhus" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/life-science-fyn.png" alt="Lifesciences Fyn" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/danish-life-science-cluster.png" alt="Danish Life Science Cluster" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/tecqan.png" alt="Tecqan" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
</div>
</div>
      </div>
    </section>
...
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><span style="font-size:16px;font-weight:600;color:#163A5F;">Erhvervshus Fyn</span></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/syddanske-forskerparker.png" alt="Forskerparken" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/life-science-fyn.png" alt="Life Science Fyn" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/danish-life-science-cluster.png" alt="Danish Life Science Cluster" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
<div style="background:#fff;border:1.5px solid rgba(22,58,95,.12);border-radius:8px;padding:10px 18px;display:flex;align-items:center;justify-content:center;min-width:160px;height:78px;"><img src="/logos/tecqan.png" alt="Tecqan" style="max-height:52px;max-width:150px;object-fit:contain;"/></div>
</div>
